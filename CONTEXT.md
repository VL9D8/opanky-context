...
OPANKY is developing a personal-AI product direction: natural-language work is routed to effective available computation while reusable experience improves later work.
...
- `opanky-outreach` — an Ashie Studio acquisition workflow; a verified private review line exists, the original local checkout is not yet adopted, and public status remains Partial, verified 2026-08-10.
...
1. Review and adopt the verified private Outreach integration line while keeping contacts and send authority private.
